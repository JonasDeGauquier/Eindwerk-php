<h1>Cookie Policy for planning master</h1>

<p>This is the Cookie Policy for planning master, accessible from planningmaster.be</p>
...
<ul>
    <li>Email: jonas.de.gauquier@student.ehb.be</li>
